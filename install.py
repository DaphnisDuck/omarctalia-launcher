...
FILES = ['MenuModel.js','VirtualMachines.qml','MenuDescriptions.js','Calculator.js','UrlSearch.js','IconResolver.qml','command-broker.py','CommandPolicy.json','CommandPolicy.js',
